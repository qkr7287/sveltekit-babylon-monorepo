import { S as i } from "./bundle-Bcg4c0dN.js";
const e = "volumetricLightingRenderVolumePixelShader", t = `#include<__decl__sceneFragment>
...
`;
i.ShadersStore[e] || (i.ShadersStore[e] = t);
const r = { name: e, shader: t };
export {
  r as volumetricLightingRenderVolumePixelShader
};
